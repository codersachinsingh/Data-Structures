...
template <typename Object> bool Vector<Object>::insert(const Object &item) {
    if (isVectorFull())
        increaseCapacity();
...
template <typename Object> bool Vector<Object>::insert(int index , const Object &item) {
